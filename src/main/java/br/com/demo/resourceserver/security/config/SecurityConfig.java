...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(
      HttpSecurity http, Converter<Jwt, Collection<GrantedAuthority>> authoritiesConverter)
      throws Exception {
    http.csrf(AbstractHttpConfigurer::disable) // API stateless
                ...
                headers
                    .xssProtection(
                        HeadersConfigurer.XXssConfig
                            ::disable) // deprecated; mantido por compatibilidade; CSP já cobre XSS
        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(ACTUATOR_HEALTH_PATHS)
                    .permitAll()
